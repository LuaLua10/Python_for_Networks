...
with open('results.txt', 'r') as f:
    for line in f.readlines():
        ...
        out_packets.append(line['Eth0-1_Out_uPackets'])
        out_octets.append(line['Eth0-1_Out_Octet'])
        in_packets.append(line['Eth0-1_In_uPackets'])
        in_octets.append(line['Eth0-1_In_Octet'])
